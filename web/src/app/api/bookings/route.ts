...
export async function POST(request: Request) {
    try {
        ...
        const { fullName, phone, email, bikeType, mainIssue, preferredTimeWindow, bookingDate, bookingTime, diagnosticAck } = body;
        ...
        // Validate booking date and time if provided
